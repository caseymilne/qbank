 ...
 * @since 1.0.0
 */
class QuizPreviousButton_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Quiz Previous Button', 'qbank' );
	}
	...
	protected function render() {
		...
		echo '<div>';
		echo '<button class="qbank-quiz-previous-button">';
		echo 'Previous';
		echo '</button>';
		echo '</div>';
