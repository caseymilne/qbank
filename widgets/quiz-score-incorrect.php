 ...
 * @since 1.0.0
 */
class QuizScoreIncorrect_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Quiz Score Incorrect', 'qbank' );
	}
