 ...
 * @since 1.0.0
 */
class QuizQuestionNumber_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Quiz Question Number', 'qbank' );
	}
	...
	protected function render() {
		...
		echo '<div class="quiz-question-number">';
		echo 'Question Number {{quiz-question-number}}';
		echo '</div>';
