 ...
 * @since 1.0.0
 */
class QuizRestartButton_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Quiz Restart Button', 'qbank' );
	}
	...
	protected function render() {
		...
		echo '<div>';
		echo '<button class="qbank-quiz-restart-button">';
		echo 'Restart';
		echo '</button>';
		echo '</div>';
