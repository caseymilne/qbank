 ...
 * @since 1.0.0
 */
class QuizReviewButton_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Quiz Review Button', 'qbank' );
	}
	...
	protected function render() {
		...
		echo '<div>';
		echo '<button class="qbank-quiz-review-button">';
		echo 'Review';
		echo '</button>';
		echo '</div>';
