 ...
 * @since 1.0.0
 */
class QuizScoreTotal_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Quiz Score Total', 'qbank' );
	}
	...
	protected function render() {
		...
		echo '<div class="quiz-score quiz-score-total">';
		echo '{{quiz-score-total}}'.'%';
		echo '</div>';
		echo '</template>';
